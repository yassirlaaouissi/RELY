...
logging.basicConfig(handlers=[logging.FileHandler('logboek.log', 'w', 'utf-8')],
...
if (Wanna_use_Tasks.upper() == "N"):
    ...
    if (WantToFilter.upper() == "Y"):
        filterOnName = input(
            "If you want to filter on name of task please give the name, else leave blank and press enter (e.g: CCleanerSkipUAC ): ")
        filterOnState = input(
            "If you want to filter on state of task please give the state, else leave blank and press enter (e.g: Completed): ")
        filterOnPath = input(
            "If you want to filter on path of task please give the path, else leave blank and press enter (e.g: \CCleanerSkipUAC): ")
...
if (want_to_use_proceslist == "N"):
    print("")
elif (want_to_use_proceslist == "Y"):
    proces_list.main()
else:
    print("Did not select Y or N, please restart program and try again")
